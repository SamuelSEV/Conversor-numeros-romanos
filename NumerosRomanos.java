...
public class NumerosRomanos {
	...
	static public void main(String[] args) {
	    ...
	    if(n==1){
	    	...
	    	sc = new Scanner(System.in);
	    	System.out.print("Introduce un numero ROMANO: ");
			R = sc.nextLine();
	...
	//metodo para pasar a numeros romanos
	static public String dec2roman(int numero) {
	...
	static public int roman2dec(String nRoman)
    {
